<!DOCTYPE html>
<!--
Permite actualizar el precio de las viviendas
-->
<html>
    <head>
        <meta charset="UTF-8">
        <title>Inmobiliaria: actualizar</title>
    ...
    <body>
        ...
        ?>
        <div class="table">
            <h3>Haz clic en el precio que deseas actualizar:</h3><hr>
            <table>
                <tr>
                    <th>Referencia</th>
                    <th>Tipo</th>
                ...
                <?php while ($vivienda = $viviendas->fetch(PDO::FETCH_ASSOC)) : ?>
                    <tr>
                        ...
                        <td class="rowPrecio">
                            <a class="rowPrecio" href="php/actualizar-precio.php?opcion=<?php echo $vivienda["referencia"]; ?>">
                                <?php echo number_format($vivienda["precio"], 0, ',', '.'); ?> €
                            </a>
                        </td>
